...
class KnowledgeBaseModel(db.Model):
    ...
    foods = db.Column(db.Text(4294000000), nullable=False)
    askable_dict = db.Column(db.Text(4294000000), nullable=False)
    
    kb_header = db.Column(db.Text(5000), nullable=False)
    calories_rules = db.Column(db.Text(5000), nullable=False)
    rules = db.Column(db.Text(5000), nullable=False)
